...
| `APPLE_APP_SITE_ASSOCIATION_TEAM_ID` | iOS 通用链接：Apple 开发者 **Team ID**（10 位），与 `APPLE_IAP_BUNDLE_ID` 组成 AASA 的 `appID`；用于 `https://noteapi.kymjs.com/wx/login/` 与微信 Universal Link |
